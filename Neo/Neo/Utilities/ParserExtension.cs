...
public static class ParserExtension
{
    ...
    public static string OnZeroVariable(this string input)
    {
        ...
        var max = dictionary.Indexers.GetMaxValue();


        return equations.AppendZeroCoefficients(dictionary).Combine();
    }
    ...
    /// <returns></returns>
    private static Indexer GetMaxValue(this List<Indexer> indexers)
    {
